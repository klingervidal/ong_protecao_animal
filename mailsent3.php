...
<head>
    <?php echo $css->meta; ?>
	<title><?php echo$css->title;?> Formulário de voluntariado</title>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center" style="padding-top: 11%;">
						<span style="color: black; font-size: 20px;">
							O formulário de voluntariado foi enviado com sucesso! Retornaremos o contato em breve.
						</span><br><br>
						<a href="formularioVoluntariado.php"><button class="btn btn-md btn-success"><span style="color: white;">Voltar</span></button></a>
                    </div>
                </div>
			</div>
	</section>
